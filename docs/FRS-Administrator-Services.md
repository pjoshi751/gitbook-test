...
For more details on the API used, please refer to [**section**](/mosip/mosip-docs/wiki/FRS-Master-Data-Services#table-of-contents)	
...
For more details, please refer to [link](/mosip/mosip-docs/wiki/FRS-Master-Data-Services#table-of-contents)
