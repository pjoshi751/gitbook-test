...
5. Update UIN details
6. Track status of UIN update
7. View history of Authentication Requests
8. Lock or Unlock UIN/VID for each ‘Auth’ type(s)
...
[[More details on ABIS Middleware|Automated Biometric Identification System (ABIS)##MOSIP ABIS Middleware)]]
